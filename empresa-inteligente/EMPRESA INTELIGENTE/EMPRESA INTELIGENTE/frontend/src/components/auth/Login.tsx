...
// Cliente temporal de Supabase SIN persistencia para validar la contraseña
// sin iniciar sesión globalmente en la app en el Paso 1.
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || "";
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || "";

const tempSupabase = createClient(supabaseUrl, supabaseAnonKey, {
  auth: {
    persistSession: false, // 👈 Evita que guarde la sesión en localStorage y redirija al Dashboard
...
export default function Login({ onLoginSuccess, onRegister }: LoginProps) {
  ...
  // Activar cámara cuando pasamos al paso de identidad y apagarla al salir/desmontar
  useEffect(() => {
    if (step === "identity") {
      startCamera();
    } else {
  ...
  const startCamera = async () => {
    try {
      ...
      setError(
        "No se pudo acceder a la cámara web. Asegúrate de dar permisos en tu navegador."
      );
    }
  };
  ...
  // PASO 1: Validar credenciales SIN guardar sesión en el navegador
  const handleAccessSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Validar correo y contraseña usando el cliente SIN persistencia
      ...
      // 2. Si la contraseña es válida, solicitamos el código OTP por correo
      ...
      if (otpError) {
        ...
        throw new Error(
          otpError.message ||
            "Error al enviar el código OTP. Verifica tu proveedor de correo en Supabase."
        );
      }
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      if (otpError) {
        throw new Error(
          otpError.message || "No se pudo reenviar el código."
        );
      }
  ...
  // PASO 2: Verificar el Código OTP con el cliente PRINCIPAL (aquí SÍ se inicia la sesión oficial)
  const handleCodeSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Usamos `supabase` (el cliente principal) para autenticar la sesión formalmente
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "24px" }}>
          <div
            style={{
              ...
              height: "48px",
              background:
                theme === "dark" ? "rgba(14, 165, 233, 0.1)" : "#e0f2fe",
              border: `1px solid ${
                theme === "dark" ? "rgba(14, 165, 233, 0.3)" : "#bae6fd"
              }`,
              borderRadius: "12px",
              display: "inline-flex",
              justifyContent: "center",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "12px",
                backgroundColor:
                  step === "access" ? "#0284c7" : t.stepInactiveBg,
                border: `1px solid ${
                  step === "access" ? "#0284c7" : t.stepInactiveBorder
                }`,
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
            ...
            <span
              style={{
                fontSize: "11px",
                marginTop: "6px",
                color: step === "access" ? "#0284c7" : t.subText,
                fontWeight: "600",
              }}
            >
              Acceso
          ...
          >
            <div
              style={{
                ...
                borderRadius: "12px",
                backgroundColor:
                  step === "code" ? "#0284c7" : t.stepInactiveBg,
                border: `1px solid ${
                  step === "code" ? "#0284c7" : t.stepInactiveBorder
                }`,
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
            ...
            <span
              style={{
                fontSize: "11px",
                marginTop: "6px",
                color: step === "code" ? "#0284c7" : t.subText,
                fontWeight: "600",
              }}
            >
              Código
          ...
          >
            <div
              style={{
                ...
                borderRadius: "12px",
                backgroundColor:
                  step === "identity" ? "#0284c7" : t.stepInactiveBg,
                border: `1px solid ${
                  step === "identity" ? "#0284c7" : t.stepInactiveBorder
                }`,
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
            ...
            <span
              style={{
                fontSize: "11px",
                marginTop: "6px",
                color: step === "identity" ? "#0284c7" : t.subText,
                fontWeight: "600",
              }}
            >
              Identidad
        ...
        <div style={{ textAlign: "center", marginBottom: "24px" }}>
          ...
          <p style={{ fontSize: "13px", color: t.subText, margin: 0 }}>
            ...
            {step === "identity" &&
              "Posiciónate frente a la cámara para validar tu rostro"}
          </p>
        </div>
          ...
          <form onSubmit={handleAccessSubmit}>
            ...
            >
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  alert("Contacta a administración de TI.");
                }}
                style={{
                  color: "#0284c7",
                  textDecoration: "none",
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <button
              ...
              style={{
                width: "100%",
                padding: "13px",
                backgroundColor: verifyingFace ? "#94a3b8" : "#0284c7",
                color: "white",
                border: "none",
                borderRadius: "10px",
                fontWeight: "600",
